function [ VoltageGradient, CurrentGradient, VOffset, IOffset, XV, XI ] = o_selectivity_value( aResConcs,aCapConcs, aVoltageOffsets, aCurrentOffsets, Xrange, CapID,plot,varargin )
%UNTITLED2 Summary of this function goes here
%   Detailed explanation goes here
error_bars = 0;
switch nargin
    case 9
        overall_std_aVOffset = varargin{1};
        overall_std_aIOffset = varargin{2};
        error_bars = 1;
end
...
if(plot)
    ...
    if(error_bars)
        errorbar(aResConcs,aVoltageOffsets,overall_std_aVOffset,'o');
        %errorbarlogx(0.03);
    end
