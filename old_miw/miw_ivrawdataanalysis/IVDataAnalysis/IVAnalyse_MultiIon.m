function [ Data ] = IVAnalyse_MultiIon(Save, FileName, PathName, VoltageZeroOffset, id,z,CapNo)
...
%   Detailed explanation goes here
    ...
    if(E.getid() > 0)
        ...
        [ P, N, O ] = GHK_FitPermeabilityMultiCharge( IV, double(E.getCapillaryConc), double(E.getReservoirConc),VInt,z);
